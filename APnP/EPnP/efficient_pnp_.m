function [R,T,Xc,best_solution]=efficient_pnp_(x3d_h,x2d_h,A,apnp)
...
[R,T]=getrotT(Xw,Xc,Xw,U,A,apnp);  %solve exterior orientation
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [R, T]=getrotT(wwpts,ccpts,Xw,U,K,apnp)
