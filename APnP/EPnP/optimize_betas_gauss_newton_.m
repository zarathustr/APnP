function [Xc_opt,R_opt,T_opt,err_opt,iter]=optimize_betas_gauss_newton_(Km,Cw,Beta0,Alph,Xw,U,A,apnp)
...
[R_opt,T_opt]=getrotT_(Xw,Xc_opt,Xw,U,A,apnp);  %solve exterior orientation

[err_opt,Urep_opt]=reprojection_error_usingRT_(0, Xw,U,R_opt,T_opt,A);
