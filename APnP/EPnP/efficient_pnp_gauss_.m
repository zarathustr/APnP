function [R,T,Xc,best_solution,opt]=efficient_pnp_gauss_(x3d_h,x2d_h,A,apnp)
...
[R,T]=getrotT(Xw,Xc,Xw,U,apnp);  %solve exterior orientation
...
Beta0=Betas/sc;
[Xc_opt,R_opt,T_opt,err_opt,iter]=optimize_betas_gauss_newton_(Kernel,Cw,Beta0,Alph,Xw,U,A,apnp);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [R, T]=getrotT(wwpts,ccpts,Xw,U,apnp)
...
if(apnp)
    [R, T] = apnp_algebraic(ccpts, wwpts, Xw, U, eye(3));
    return;
else
